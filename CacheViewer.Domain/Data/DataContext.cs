...
namespace CacheViewer.Domain.Data
{
    ...
    /// 
    /// For example if you load 100 items but you will need to access only items from one brand it is not needed to load items 
    ...
    /// use either third strategy called explicit loading or separate queries to load items and than products for all items you need.
