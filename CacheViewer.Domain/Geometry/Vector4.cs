namespace CacheViewer.Domain.Geometry
{
    ...
    public struct Vector4 : IEquatable<Vector4>
    {
        ...
        /// <remarks><seealso cref="M:Vector4.#ctor(Vector3,System.Single)" /></remarks>
        ...
        /// <see cref="P:Vector4.LengthFast" />
        /// <seealso cref="P:Vector4.LengthSquared" />
        public float Length
        {
            get
            {
        ...
        /// </remarks>
        /// <see cref="P:Vector4.Length" />
        /// <seealso cref="P:Vector4.LengthFast" />
        ...
        {
            result = new Vector4((float)((double)mat.Row0.X * (double)vec.X + (double)mat.Row0.Y * (double)vec.Y + (double)mat.Row0.Z * (double)vec.Z + (double)mat.Row0.W * (double)vec.W), (float)((double)mat.Row1.X * (double)vec.X + (double)mat.Row1.Y * (double)vec.Y + (double)mat.Row1.Z * (double)vec.Z + (double)mat.Row1.W * (double)vec.W), (float)((double)mat.Row2.X * (double)vec.X + (double)mat.Row2.Y * (double)vec.Y + (double)mat.Row2.Z * (double)vec.Z + (double)mat.Row2.W * (double)vec.W), (float)((double)mat.Row3.X * (double)vec.X + (double)mat.Row3.Y * (double)vec.Y + (double)mat.Row3.Z * (double)vec.Z + (double)mat.Row3.W * (double)vec.W));
        }
        ...
        {
            return string.Format("({0}{4} {1}{4} {2}{4} {3})", (object)this.X, (object)this.Y, (object)this.Z, (object)this.W, (object)Vector4.listSeparator);
        }
