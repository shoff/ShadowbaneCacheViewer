...
namespace CacheViewer.Domain.Services.Prefabs
{
    ...
    public class RangerBlindService
    {
        ...
        private readonly string folder = AppDomain.CurrentDomain.BaseDirectory + "Assembled\\RangerBlind";
        //424005
        //424011
        //424020
        //424017
        ...
        public RangerBlindService()
        {
            ...
            using (var context = new DataContext())
            {
                var indexes = (
                    ...
                    where c.Name == "Ranger Blind" && c.ObjectType == ObjectType.Structure
                    select c).ToList();
