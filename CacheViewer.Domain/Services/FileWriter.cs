...
namespace CacheViewer.Domain.Services
{
    ...
    {
        private static readonly FileWriter instance = new FileWriter();
        ...
        /// <exception cref="UnauthorizedAccessException">The <paramref>
        ///     <name>access</name>
        ///   </paramref>
        ///   requested is not permitted by the operating system for the specified <paramref name="path" />, such as when <paramref name="access" /> is Write or ReadWrite and the file or directory is set for read-only access. </exception>
