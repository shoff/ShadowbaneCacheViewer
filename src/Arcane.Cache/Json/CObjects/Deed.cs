...
public class Deed
{
    ...
    public ObjSoundEvents[] obj_sound_events { get; set; } = Array.Empty<ObjSoundEvents>();
    ...
    public int item_skill_used { get; set; }
    public int item_skill_mastery_used { get; set; }
    ...
    public bool item_has_stub { get; set; }
    ...
    public int deed_type { get; set; }
    public int deed_furniture_id { get; set; }
    public int deed_target_id { get; set; }
    public int deed_employment { get; set; }
    public int deed_start_rank { get; set; }
    public int deed_name_lookup { get; set; }
    public bool deed_indoors { get; set; }
    public bool deed_is_fortress { get; set; }
    public float deed_namelookup_val { get; set; }
    public bool deed_custom_city { get; set; }
    public int deed_structure_id { get; set; }
}