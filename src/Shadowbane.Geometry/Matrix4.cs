...
public struct Matrix4 : IEquatable<Matrix4>
{
    ...
    {
        get => new(this.Row0.X, this.Row1.X, this.Row2.X, this.Row3.X);
        set
        {
            this.Row0.X = value.X;
            this.Row1.X = value.Y;
    ...
    {
        get => new(this.Row0.Y, this.Row1.Y, this.Row2.Y, this.Row3.Y);
        set
        {
            this.Row0.Y = value.X;
            this.Row1.Y = value.Y;
    ...
    {
        get => new(this.Row0.Z, this.Row1.Z, this.Row2.Z, this.Row3.Z);
        set
        {
            this.Row0.Z = value.X;
            this.Row1.Z = value.Y;
    ...
    {
        get => new(this.Row0.W, this.Row1.W, this.Row2.W, this.Row3.W);
        set
        {
            this.Row0.W = value.X;
            this.Row1.W = value.Y;
    ...
    {
        get => new(this.Row0.X, this.Row1.Y, this.Row2.Z, this.Row3.W);
        set
        {
            this.Row0.X = value.X;
            this.Row1.Y = value.Y;
