...
public class Mesh : IMesh
{
    ...
    public void ApplyPosition()
    {
        ...
        var translationMatrix = Matrix4x4.CreateTranslation(this.Position);
        foreach (var v in this.Vertices)
        {
            var v4 = new Vector4(v.X, v.Y, v.Z, 1);
            var v4Translated = Vector4.Transform(v4, translationMatrix);
            positioned.Add(new Vector3(v4Translated.X, v4Translated.Y, v4Translated.Z));
        }
        this.Vertices = positioned;
    }
